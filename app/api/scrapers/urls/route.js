...
export async function POST(req) {
  try {
    ...
    const { scraperId, includedUrls, excludedUrls } = body;
    ...
    console.log('Looking for scraper with:', {
    ...
    // Update the scraper document with the URLs
    console.log('Updating scraper:', scraperId);
    console.log('Included URLs:', includedUrls.length);
    console.log('Excluded URLs:', excludedUrls.length);
